  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-slate-50">
      <div className="w-full max-w-md p-8 bg-white shadow-lg rounded-xl">
        <h1 className="mb-6 text-3xl font-bold text-center text-blue-600">Sign In</h1>
        ...
        <p className="mt-4 text-center">
          New here? <Link to="/register" className="font-bold text-blue-600">Create Account</Link>
        </p>
      </div>
    </div>
  );
